...
export const expandedWeapons: Weapon[] = [
  ...
  gun({
    ...
    slug: 'beretta-m1938a',
    name: 'Beretta M1938A',
    designation: 'Moschetto Automatico Beretta Modello 1938A',
    subcategory: 'smg',
    country: country('IT'),
    manufacturer: 'Pietro Beretta',
    yearIntroduced: 1938,
    yearRetired: 1945,
    imageUrl: '/weapons-expanded/beretta-m1938a.jpg',
    specs: {
      caliber: '9x19mm Parabellum',
      action: 'Blowback, open bolt',
      rateOfFire: 600,
    ...
    overview: 'Italian submachine gun noted for reliability, controllability, and strong build quality.',
    notableUses: ['Italian infantry and paratrooper units', 'North Africa and Italian campaigns'],
  }),
  gun({
    id: 'mas-36',
    slug: 'mas-36',
    name: 'MAS-36',
    designation: 'Fusil MAS-36',
    subcategory: 'rifle',
    country: country('FR'),
    manufacturer: "Manufacture d'armes de Saint-Etienne",
    yearIntroduced: 1937,
    yearRetired: 1978,
    imageUrl: '/weapons-expanded/mas-36.png',
    specs: {
    ...
    overview: 'French service rifle adopted just before WW2 and fielded by Free French and postwar forces.',
    notableUses: ['Battle of France 1940', 'Free French forces in North Africa and Europe'],
  }),
  ...
  tank({
    ...
    yearIntroduced: 1940,
    yearRetired: 1943,
    imageUrl: '/weapons-expanded/m13-40.jpg',
    specs: {
      crew: 4,
      weight: 14,
      armor: { front: 42, side: 25, rear: 25 },
      mainArmament: '47mm Cannone da 47/32',
      engine: 'Fiat SPA 8T diesel (125 hp)',
      maxSpeed: 32,
      range: 200,
      productionCount: 710,
    },
    overview: 'Main Italian medium tank in early North African fighting, balancing mobility with modest protection.',
    notableUses: ['North Africa campaign', 'Operation Compass and Gazala battles'],
  }),
  tank({
    id: 'somua-s35',
    slug: 'somua-s35',
    name: 'SOMUA S35',
    designation: 'Char de Cavalerie SOMUA S35',
    subcategory: 'medium-tank',
    country: country('FR'),
    manufacturer: 'SOMUA',
    yearIntroduced: 1936,
    yearRetired: 1943,
    imageUrl: '/weapons-expanded/somua-s35.jpg',
    specs: {
      crew: 3,
      weight: 19.5,
      armor: { front: 47, side: 40, rear: 35 },
      mainArmament: '47mm SA 35 gun',
      engine: 'SOMUA V-8 petrol (190 hp)',
      maxSpeed: 40,
      range: 230,
      productionCount: 430,
    },
    overview: 'French cavalry tank with strong armor and a high-velocity gun for the 1940 campaign period.',
    notableUses: ['Battle of France 1940', 'French armored cavalry divisions'],
  }),
  ...
  plane({
    id: 'macchi-c202-folgore',
    slug: 'macchi-c202-folgore',
    name: 'Macchi C.202 Folgore',
    designation: 'Macchi C.202 Serie',
    subcategory: 'fighter',
    country: country('IT'),
    manufacturer: 'Aeronautica Macchi',
    yearIntroduced: 1941,
    yearRetired: 1948,
    imageUrl: '/weapons-expanded/macchi-c202-folgore.jpg',
    specs: {
      crew: 1,
      wingspan: 10.58,
      maxSpeed: 600,
      range: 765,
      ceiling: 11500,
      armament: ['2x 12.7mm Breda-SAFAT machine guns', '2x 7.7mm machine guns (many variants)'],
      engine: 'Alfa Romeo RA.1000 RC.41 (DB 601A license-built)',
      productionCount: 1150,
    },
    overview: 'Italian fighter that significantly improved Regia Aeronautica performance in Mediterranean combat.',
    notableUses: ['Mediterranean air war', 'Defense of Italian mainland and Sicily'],
  }),
  plane({
    id: 'dewoitine-d520',
    slug: 'dewoitine-d520',
    name: 'Dewoitine D.520',
    designation: 'Chasseur Dewoitine D.520',
    subcategory: 'fighter',
    country: country('FR'),
    manufacturer: 'SNCAM',
    yearIntroduced: 1940,
    yearRetired: 1953,
    imageUrl: '/weapons-expanded/dewoitine-d520.jpg',
    specs: {
      crew: 1,
      wingspan: 10.2,
      maxSpeed: 535,
    ...
    overview: "France's most modern frontline fighter of 1940, later flown by multiple wartime French factions.",
    notableUses: ['Battle of France 1940', 'Vichy and Free French service'],
  }),
  ...
  naval({
    id: 'littorio-class-battleship',
    slug: 'littorio-class-battleship',
    name: 'Littorio-class Battleship',
    designation: 'Littorio / Vittorio Veneto class',
    subcategory: 'battleship',
    country: country('IT'),
    manufacturer: 'Ansaldo / CRDA',
    yearIntroduced: 1940,
    yearRetired: 1945,
    imageUrl: '/weapons-expanded/littorio-class-battleship.jpg',
    specs: {
      displacement: 45700,
      length: 237.8,
      speed: 30,
      ...
      armor: { belt: 350, deck: 162 },
    },
    overview: 'Modern Italian fast battleship class built for Mediterranean fleet actions under air and naval threat.',
    notableUses: ['Mediterranean convoy battles', 'Regia Marina fleet operations 1940-43'],
  }),
  naval({
    id: 'richelieu-battleship',
    slug: 'richelieu-battleship',
    name: 'Richelieu',
    designation: 'Richelieu-class Battleship',
    subcategory: 'battleship',
    country: country('FR'),
    manufacturer: 'Arsenal de Brest',
    yearIntroduced: 1940,
    yearRetired: 1968,
    imageUrl: '/weapons-expanded/richelieu-battleship.jpg',
    specs: {
      displacement: 48000,
      length: 247.9,
      speed: 32,
      ...
      armor: { belt: 330, deck: 170 },
    },
    overview: 'French fast battleship that later served with Allied fleets after refit and modernization.',
    notableUses: ['Operations with Allied Eastern Fleet', 'Atlantic and Indian Ocean service'],
  }),
